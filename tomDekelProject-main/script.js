...
const smartQuotes = ["work hard in silence, let your success be your noise.",
...
function addCards(){
    ...
    const landingPageTitles = ['<h3>תן לנו להוביל אותך קדימה</h3>', '<h3>כאן ועכשיו</h3>', '<h3>קפה טוב לבוקר טוב</h3>', '<h3>תן לנו להוביל אותך קדימה</h3>', '<h3>גלריית תמונות</h3>',
        ...
        const jsProjectsTitles = [
            ...
            {name: "songGame",
                ...
                preview: "/tomDekelProject-main/projects/song_guessing_game/projectpreview-songGame.html"
            },
            {name: "tic-tac-toe",
                pic: "./pictures/tictactoe-pic.png",
                title: "old fashioned tic tac toe",
                preview: "/tomDekelProject-main/projects/ticTacToe/projectpreview-tic-tac-toe.html"
            },
            {name: "countriesAPI",
                pic: "./pictures/countriesAPI-pic.png",
                title: "countries API",
                preview: "/tomDekelProject-main/projects/countries api/projectpreview-countriesAPI.html"
            },
            {name: "math-game",
                pic: "./pictures/mathGame-pic.png",
                title: "Math learning game",
                preview: "/tomDekelProject-main/projects/mathGame/projectpreview-mathGame.html"
            },
            {name: "Clock Designer",
                pic: "./pictures/clockProject-pic.png",
                title: "javaScript rendered clock",
                preview: "/tomDekelProject-main/projects/analog-clock/projectpreview-clockDesigner.html"
            },
        ];
